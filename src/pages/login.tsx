    ...
    return (
      <div className="md:py-8 bg-white rounded-2xl shadow-2xl flex flex-col w-full md:w-1/3 items-center max-w-8xl transition duration-1000 ease-out">
        ...
        <div className="flex flex-col items-center  m-5 justify-center">
          ...
          <button className="rounded-2xl text-white bg-blue-400 w-2/5 px-4 py-2 shadow-md hover:text-blue-600 hover:bg-white transition duration-200 ease-in">
            Sign In
          </button>
        </div>
    ...
    return (
      ...
      <div className="bg-blue-400 text-white rounded-2xl shadow-2xl  flex flex-col w-full  md:w-1/3 items-center max-w-4xl transition duration-1000 ease-in">
        ...
        <div className="flex flex-col items-center justify-center mt-2 ">
          ...
          ></input>
         <select id="postType" style={{ color: 'gray' }} className="rounded-2xl px-5 py-1 w-4/5 md:w-full  focus:border-pink-400  border-[1px] m-1 border-gray-400 " required>
         ...
         <option value="other" style={{ color: '#000' }}>Autre</option>
          ...
          <button className="rounded-2xl mt-2 mb-2 text-blue-400 bg-white w-1/3 px-2 py-2 shadow-md hover:text-white hover:bg-blue-400 transition duration-200 ease-in">
            Sign Up
          </button>
        </div>
        <div className="inline-block border-[1px] justify-center w-20 border-white border-solid"></div>
